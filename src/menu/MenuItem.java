...
public class MenuItem extends javax.swing.JPanel {
    ...
    public MenuItem(Icon icon, String menuName,ActionListener act, MenuItem... subMenu) {
        ...
        this.setSize(new Dimension(Integer.MAX_VALUE,47));
        this.setMaximumSize(new Dimension(Integer.MAX_VALUE,47));
        this.setMinimumSize(new Dimension(Integer.MAX_VALUE,47));
    ...
    private void initComponents() {
        ...
        lblname.setFont(new java.awt.Font("Sitka Text", 0, 14)); // NOI18N
